...
<%
	...
	logger.info("HBD1LOGIN_Index.jsp");
%>
<!DOCTYPE html>
<html>
<head>
...
<form class="form-signin" id="loginForm" action="/shop.go?webactionID=HBD1LOGIN&actionMethod=jr" method="post">
  ...
  <!--    -->
  <a href="###" onclick="javascript:$('#txtLoginID').val('0901344904');$('#txtPassword').val('123456');">家成</a> |  
  <a href="###" onclick="javascript:$('#txtLoginID').val('0905555171');$('#txtPassword').val('123456');">阿志</a> |
  <a href="###" onclick="javascript:$('#txtLoginID').val('0915061888');$('#txtPassword').val('123456');">文洲</a> |
  <a href="###" onclick="javascript:$('#txtLoginID').val('0926980066');$('#txtPassword').val('123456');">金龍</a> |
  <a href="###" onclick="javascript:$('#txtLoginID').val('0956565656');$('#txtPassword').val('123456');">小潘</a> |
  <a href="###" onclick="javascript:$('#txtLoginID').val('0936504316');$('#txtPassword').val('123456');">紅毛</a> |
  <a href="###" onclick="javascript:$('#txtLoginID').val('0955187080');$('#txtPassword').val('123456');">忠霖</a> |
  <a href="###" onclick="javascript:$('#txtLoginID').val('0982121721');$('#txtPassword').val('123456');">維漢</a>
